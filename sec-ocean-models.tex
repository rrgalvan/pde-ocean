...
\begin{frame}{Hydrostatic Navier--Stokes equations}
%------------------------------------------------------------
...
\begin{frame}{A First Approach to Shallow Waters Equations}
  \small
  % A first approach: let us
  % \medskip
  \begin{itemize}
  ...
  \item We arrive to the following %  \textbf{Shallow
    % waters} %equations, with unknowns $(u_1,u_2)$, $H$:
  problem:
    \begin{itemize}
  ...
  \end{itemize}
    ...
    \end{BlockNoTitle}
      ...
      \item Numerical approaches~\llaveizq{Finite Volumes,\\
          Discontinuous Galerkin,\\ Stabilized Finite
          Elements...}
      \end{itemize}
\end{frame}

\begin{frame}{Shallow Waters (or Saint-Venant) Equations}
    \PlayVideoWithLabel[0.9\linewidth][0.5\linewidth][Tsunami near ``Cabo de São Vicente'']{%
      video/tsunami2.avi}
    \small
    \begin{itemize}
